...
/**
 * Efficient reader for data that consists of text lines, i.e. character data separated by one of standard line feeds (CR, LF or CR+LF).
 */
public class RawTextLineReader extends DataReader<byte[]> {
	...
	/**
	 * Convenience method for instantiating factory to create instances of this link DataReader.
	 */
